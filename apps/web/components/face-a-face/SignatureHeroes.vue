...
<template>
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <div>
      ...
      <div class="space-y-2">
        <div v-for="hero in me" :key="hero.heroId" class="flex items-center gap-3 rounded-lg border border-l-4 border-border border-l-brand bg-surface p-3">
    ...
    <div>
      ...
      <div class="space-y-2">
        <div
          ...
          :key="hero.heroId"
          class="flex items-center gap-3 rounded-lg border border-l-4 border-border border-l-accent bg-surface p-3"
        >
          <HeroesHeroAvatar :hero-id="hero.heroId" :name="hero.heroName" :size="32" />
          <div class="min-w-0 flex-1">
            <div class="flex items-center justify-between gap-2">
