  ...
  <div v-if="battletags.length > 0" class="rounded-lg border border-border bg-surface p-3">
    ...
    <div v-else class="flex flex-wrap gap-2">
      <button
        ...
        type="button"
        class="flex min-w-[9.5rem] flex-1 items-center gap-2.5 rounded-md border px-2.5 py-2 text-left transition-colors hover:bg-background focus-visible:bg-background"
